...
def POLYR_GetWireframe(*args):
    ...
    Returns
    -------
    coor (double array) : reference on the coor vector seen as a numpy array
    connectivity (integer array) : reference on the connectivity vector seen as a
    numpy array  
...
def PRPRx_UseCpF2fDetection(*args):
    ...
    python usage : PRPRx_UseCpF2fExplicitDetection(tol,iter, cd_shrink=0.,
    an_shrink=0., delta=0.)  
...
def PRPRx_UseTrianglesIntersectionDetection(*args):
    ...
    chooses contact detection using shadow overlap detection  
...
def PRPRx_ShrinkPolyrFaces(*args):
    ...
    Parameters
    ----------
    shrink(real) : scale factor allowing to shrink candidate surface 0. no shrink, 1.
        no surface  
...
def deposit2D_Gravity(*args):
    ...
    **Warning**: we assume nb_coor=2*nb_particles  
    ...
    Parameters
    ----------
    nb_particles(int): number of particles  
    given_radii(double *): given radii list (i.e. granulometry)  
    lx(double): width of the box  
    nb_coor(int): number of coordinates  
    computed_coor(double *): coordinates of the deposited particles [x1, y1, x2, y2, ...]  

    """
    return _lmgc90.deposit2D_Gravity(*args)

def deposit2D_GravityAndBigParticles(*args):
    r"""


    """
    return _lmgc90.deposit2D_GravityAndBigParticles(*args)

def deposit2D_Wall(*args):
    r"""
    ...
    **Warning**: we assume nb_coor=2*nb_particles  
    ...
    """
    return _lmgc90.deposit2D_Wall(*args)

def deposit2D_WallAndBigParticles(*args):
    r"""


    """
    return _lmgc90.deposit2D_WallAndBigParticles(*args)

def deposit2D_Heterogeneous(*args):
    r"""


    """
    return _lmgc90.deposit2D_Heterogeneous(*args)

def deposit3D_Box(*args):
    r"""
    ...
    **Warning**: :  
        ...
        *   radii is modified by this function: the radii and coordinates of non
            deposited particles are set to 0  
        *   a point (x, y, z) is in the box iff x is in [-lx/2, lx/2], y is in
            [-ly/2, ly/2] and z is in [0, lz]  

    python call: [computed_coor, nb_comp_particles]=deposit3D_Box(radii, lx, ly, lz,
    nb_coor[, seed])  

    Parameters
    ----------
    nb_particles(integer): number of particles  
    radii(double array): given radii list (i.e. granulometry)  
    lx(double): width of the box, following Ox axis  
    ly(double): width of the box, following Oy axis  
    lz(double): height of the box  
    nb_coor(integer): number of coordinates  
    seed(integer array) (optional) : an input seed to control randomness  

    Returns
    -------
    computed_coor (double array): coordinates of the deposited particles [x1, y1,
    z1, x2, y2, z2, ...]  
    nb_comp_particles (integer): number of deposited particles PYDOC  

    """
    return _lmgc90.deposit3D_Box(*args)

def deposit3D_HeterogeneousBox(*args):
    r"""


    Computes a new deposit under gravity in a box where some particles are already
    deposited.  
    ...
    **Warning**: :  
    ...
    python call: [computed_coor,
    nb_comp_particles]=deposit3D_HeterogeneousBox(radii, lx, ly, lz,
    deposited_radii, deposited_coor, nb_coor[, seed])  
    ...
    ly(double): width of the box, following Oy axis  
    lz(double): height of the box  
    nb_deposited_particles(integer): number of already deposited particles  
    deposited_radii(double array): radii of the deposited particles  
    nb_deposited_coor(integer): number of coordinates of the deposited particles  
    deposited_coor(double array): coordinates of the deposited particles [X1, Y1, Z1, X2, Y2,
        Z2, ...]  
    nb_coor(integer): number of coordinates  
    seed(integer array) (optional) : an input seed to control randomness  
    ...
    """
    return _lmgc90.deposit3D_HeterogeneousBox(*args)

def deposit3D_Cylinder(*args):
    r"""
    ...
    **Warning**: :  
        ...
        *   radii is modified by this function: the radii and coordinates of non
            deposited particles are set to 0  
        *   a point (x, y, z) is in the cylinder iff x^2 + y^2 is in [0, R^2] and z
            is in [0, lz]  

    python call: [computed_coor, nb_comp_particles]=deposit3D_Cylinder(radii, R, lz,
    nb_coor[, seed])  
    ...
    nb_particles(integer): number of particles  
    radii(double array): given radii list (i.e. granulometry)  
    R(double): radius of the cylinder  
    lz(double): height of the cylinder  
    nb_coor(integer): number of coordinates  
    seed(integer array) (optional) : an input seed to control randomness  
    ...
    """
    return _lmgc90.deposit3D_Cylinder(*args)

def deposit3D_HeterogeneousCylinder(*args):
    r"""


    Computes a new deposit under gravity in a cylinder where particles are already
    deposited.  
    ...
    **Warning**: :  
    ...
    python call: [computed_coor,
    nb_comp_particles]=deposit3D_HeterogeneousCylinder(radii, R, lz,
    deposited_radii, deposited_coor, nb_coor[, seed])  
    ...
    """
    return _lmgc90.deposit3D_HeterogeneousCylinder(*args)

def deposit3D_Sphere(*args):
    r"""
    ...
    **Warning**: :  
        ...
        *   radii is modified by this function: the radii and coordinates of non
            deposited particles are set to 0  
        *   a point (x, y, z) is in the sphere iff (x - x_C)^2 + (y - y_C)^2 + (z -
            z_C)^2 is in [0, R^2]  

    python call: [computed_coor, nb_comp_particles]=deposit3D_Sphere(radii, R,
    center, nb_coor[, seed])  
    ...
    center(double[3]): center of the sphere [x_C, y_C, z_C]  
    nb_coor(integer): number of coordinates  
    seed(integer array) (optional) : an input seed to control randomness  
    ...
    """
    return _lmgc90.deposit3D_Sphere(*args)

def deposit3D_HeterogeneousSphere(*args):
    r"""


    Computes a new deposit under gravity in a sphere where particles are already
    deposited.  
    ...
    **Warning**: :  
    ...
    python call: [computed_coor,
    nb_comp_particles]=deposit3D_HeterogeneousSphere(radii, R, center,
    deposited_radii, deposited_coor, nb_coor[, seed])  
    ...
    """
    return _lmgc90.deposit3D_HeterogeneousSphere(*args)
...
def mesh2D_MeshQ4(*args):
    ...
    *   conn = [1, 3, 4, 2, 3, 5, 6, 4]  
        ...
        **Warning**: python call: [coor, nb_node_per_ele, conn]=mesh2D_MeshQ4(x0,
            y0, lx, ly, nb_elem_x, nb_elem_y, size_coor, size_nb_node_per_ele,
            size_conn)  
